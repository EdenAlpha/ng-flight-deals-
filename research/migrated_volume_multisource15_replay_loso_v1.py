...
V2 keeps the exact 15-tile data/model/replay protocol and extends source fitting
from 6 to 10 epochs because the frozen 6-epoch logs were still improving.
...
MAX_TRAIN=1200000
EPOCHS=10
PROTOCOL='multisource-15tile-full-replay-v2-10epochs'
